      ...
      <div className="container">
        <div className="blog">
          <div className="section-title-box pb-30">
            <span className="section-sub-title pb-30">BLOG POST</span>
            <h2 className="section-title pb-30">
              Latest Article From Our Blog
            </h2>
          </div>
          <ul className="blog-list flex flex-center-x">
            <li className="blog-item col-small-12 col-medium-6 col-large-4 col-largest-4 ">
              <div className="blog-item-img">
                <NavLink to="/blog-detail" className="blog-item-img-link">
                  <img src={blog1} alt="blog1" />
                </NavLink>
                <NavLink to="/blog-grid" className="blog-tag">
                  Branding
                </NavLink>
              </div>
